...
function createSidePanel() {
  ...
  const chatContainer = sidePanel.querySelector('#chat-container') as HTMLDivElement
  ...
  function renderMessages() {
    ...
    messages.forEach((msg: any, index: number) => {
      ...
      messageDiv.style.cssText = `
        ...
        box-shadow: ${msg.type === 'user' ? '0 1px 6px rgba(90, 156, 255, 0.2)' : '0 1px 3px rgba(0,0,0,0.04)'};
  ...
  chatInput.addEventListener('focus', () => {
    ...
    chatInput.style.boxShadow = '0 0 0 3px rgba(90, 156, 255, 0.06), 0 4px 16px rgba(0, 0, 0, 0.1)'
  })
